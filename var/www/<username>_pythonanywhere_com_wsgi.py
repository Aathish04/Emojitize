...
# #import sys
# #
# #path = '/home/<username>/path/to/my/app
...
# #import sys
# #
# ## The "/home/<username>" below specifies your home
# ## directory -- the rest should be the directory you uploaded your Flask
# ## code to underneath the home directory.  So if you just ran
# ## "git clone git@github.com/myusername/myproject.git"
# ## ...or uploaded files to the directory "myproject", then you should
# ## specify "/home/<username>/myproject"
# #path = '/home/<username>/path/to/flask_app_directory'
# #if path not in sys.path:
# #    sys.path.append(path)
# #
...
project_home = u'/home/<username>/Emojitize'
if project_home not in sys.path:
    sys.path = [project_home] + sys.path

# import flask app but need to call it "application" for WSGI to work
from Emojiweb import app as application

path = '/home/<username>/Emojitize/Emojiweb.py'
if path not in sys.path:
   sys.path.append(path)